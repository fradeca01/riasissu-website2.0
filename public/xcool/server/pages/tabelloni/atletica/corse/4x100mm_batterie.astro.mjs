...
const $$4X100MMBatterie = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const path = `https://storage.googleapis.com/riasissu-7c453.firebasestorage.app/xcool-data/atletica/4x100mM_batterie.json`;
  let res;
  try {
