import{n,j as e,k as f}from"./emotion-styled.browser.esm.BVmeO7Kq.js";import{r}from"./index.Cj_FO6QK.js";import{I as v}from"./index.D7o1cKHt.js";import{C as b,H as z}from"./Hero.SR65yZWU.js";import{M as c}from"./index.pRwWRSYz.js";import{B as a}from"./index.D0tKD-p0.js";import{FadeIn as t}from"./FadeIn.6oxE79rk.js";import"./index.b-FexVqW.js";import"./index.mQMKPyKF.js";/* empty css                      */import"./styled.SpwDvkbu.js";const w=n.section`
    padding: 100px 0;
...
`,N=({children:o,...s})=>o?e.jsx(w,{...s,children:e.jsx(b,{children:e.jsx(y,{children:o})})}):null,S=f`
...
`,E=n.div`                
        ...
        ${c.max("md")} {
            flex-direction: column;
            gap: 0px;
        }`;const B=({})=>{const o="https://us-central1-riasissu-7c453.cloudfunctions.net/passwordProtectedPage?password=",[s,x]=r.useState(""),[d,h]=r.useState(!1),[m,l]=r.useState(null),[g,p]=r.useState(!1);r.useEffect(()=>{localStorage.getItem("authorized")==="true"&&p(!0)});const j=async()=>{if(s.trim()){h(!0),l(null);try{const i=await fetch(`${o}${s}`,{method:"GET",mode:"cors",credentials:"omit"});if(!i.ok)throw new Error("Password errata.");(await i.json()).redirectUrl?(p(!0),localStorage.setItem("authorized","true")):l("Errore: nessun URL ricevuto.")}catch(i){const u=i instanceof Error?i.message:"Errore sconosciuto";l(u||"Errore di connessione.")}finally{h(!1)}}};return g?e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
    .button-container {
        margin-bottom: 3rem;
        width: 100%;
        display: flex;
