...
`,c=r.div`
  ...
  font-size: 14px;
  color: #cbcacd;
`,B=()=>o.jsxs(n,{children:[o.jsx("center",{children:o.jsx("h2",{children:"Tabelloni e Gironi"})}),o.jsx(_,{children:o.jsx(u,{children:w.map(i=>o.jsxs(v,{href:i.href,children:[o.jsx(z,{src:i.imgSrc,alt:i.title}),o.jsxs(S,{children:[o.jsx(C,{children:i.title}),o.jsxs(c,{children:[o.jsx("strong",{children:"Formato: "}),i.format]}),o.jsxs(c,{children:[o.jsx("strong",{children:"Partecipanti: "}),i.participants]})]})]},i.href))})})]});export{B as default};
